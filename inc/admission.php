...
class Admission extends DatabaseObject {
 ...
 protected static $table_name = "admission_status";
 public $db_fields=array('admission_id','applicant_id', 'time_completed_application','academic_session','status', 'reason');
	
	public $admission_id ;
	public $applicant_id;
	public $time_completed_application;
   ...
   */
	...
	public function update() {
	  global $database;
		...
		$sql .= " WHERE admission_id=". $database->escape_value($this->admission_id);
