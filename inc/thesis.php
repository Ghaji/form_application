...
class Thesis extends DatabaseObject {
 ...
 protected static $table_name = "thesis_details";
 public $db_fields=array('thesis_id','applicant_id','comment_on_field','thesis_topic','proposal_on_thesis','thesis_attachment');
	
	public $thesis_id;
	public $applicant_id;
	public $comment_on_field;
    public $thesis_topic;
	public $proposal_on_thesis;
	public $thesis_attachment;
   ...
   */
	...
	public function save() {
	  ...
	  return isset($this->thesis_id) ? $this->update() : $this->create();
	}
