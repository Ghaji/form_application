...
if(isset($_GET['applicant_id']) || isset($_GET['form_id']))
{
$applicant_id = $_GET['applicant_id'];
$form_id = $_GET['form_id'];
//$form_id = customDecrypt($_GET['invoice']);
...
?>
<?php
    $sqlprogrammedetails = "SELECT * FROM personal_details p, department d, faculty f, photographs photo WHERE p.applicant_id=".$applicant_id." AND p.programme_applied_id=d.department_id AND d.faculty_id=f.faculty_id AND p.applicant_id = photo.applicant_id";
