...
<section class="slice">
    ...
    <div id="invoice" class="paid">
        <div class="this-is" style="margin-bottom: 10px;">
            <strong>APPLICATION FORM INVOICE FOR <?php echo $sessiondetails['session']; ?> ACADEMIC SESSION</strong>
        </div>
                ...
                <tr>
                    ...
                    <td width="50%">
                        <dl class="invoice-meta">
                            ...
                            <dd><?php echo $student_status.$session->applicant_id.$invoicedetails['invoice_id']; ?></dd>
                            <dt class="invoice-date">Date</dt>
                            <dd><?php echo date('m-d-Y', strtotime($paymentdetails['payment_date'])); ?></dd>
                ...
                <td >
                    <div >
                        ...
                        <div id="hcard-Hiram-Roth" class="vcard">
                            <a class="url fn">
                                <?php echo $programmedetails['surname'].' '.$programmedetails['first_name'].' '.$programmedetails['middle_name']; ?>
                            </a>
                            <div class="org"><?php echo $programmedetails['form_id']; ?></div>
                            <div><?php echo $paymentdetails['pin']; ?></div>
                            
                            <div class="adr">
                                <div><?php echo $programmedetails['faculty_name']; ?></div>
                                <div><?php echo $programmedetails['department_name']; ?></div>
                            </div>
                        </div>
                    </div>
                </td>
            ...
            <div class="invoice-items">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            <th>Programme</th>
                            <td>&#8358;<?php echo $paymentdetails['amount']; ?>.00</td>
                        </tr>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>&#8358;<?php echo $trans; ?>.00</td>
                        </tr>
                        <tr>
                            <th>Total:</th>
                            <td>&#8358;<?php echo $paymentdetails['amount'] + $trans; ?>.00</td>
                        </tr>
                    </tbody>
                </table>
