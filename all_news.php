	...
	<div class="row-fluid">
        ...
        <p align="justify" >
                     ...
                     <?php  echo $item->content;?>        
                      ...
                      <table width="60%">
                        <tr><td>
                              <a href="javascript:history.go(-1)" class="text-warning pull-left btn">
                             <i class="icon-arrow-left"></i> Back
                             </a> 
                            </td>
                            <td align="right">
                             <a href="news_archives.php" class="text-success pull-left btn" align="center">
                               View Archived <i class="icon-book"></i> 
                            </a>
                          </td></tr>
                      </table>
                          </div> 
           ...
           echo '<h4 class="text-center text-info">No related items For this Request ! Contact The administrator</h4>';
